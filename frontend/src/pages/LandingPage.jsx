...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1123] text-white">
      ...
      {/* Navbar */}
      <nav className="bg-[#1a1d35]/90 backdrop-blur border-b border-[#2d3155] px-6 py-3 flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => navigate('/login')} className="text-slate-400 hover:text-white text-sm transition-colors px-4 py-2">
            Sign In
          </button>
          <button onClick={() => navigate('/login')} className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm px-4 py-2 rounded-xl transition-colors">
            Get Started Free
          </button>
        </div>
      </nav>
      ...
      <section className="relative min-h-[85vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
          <div className="inline-flex items-center gap-2 bg-indigo-600/20 border border-indigo-500/30 text-indigo-300 text-sm px-4 py-1.5 rounded-full mb-6">
          ...
          <div className="flex items-center justify-center gap-4 mb-14">
            <button onClick={() => navigate('/login')}
              className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3.5 rounded-xl font-semibold text-lg transition-colors">
              <Zap size={20} /> Start Teaching Free
            </button>
            <button onClick={() => navigate('/login')}
              className="flex items-center gap-2 border border-[#2d3155] hover:border-indigo-500 text-slate-300 hover:text-white px-8 py-3.5 rounded-xl font-semibold text-lg transition-colors">
          ...
          <div className="flex items-center justify-center gap-6">
            <div className="bg-[#1a1d35]/90 backdrop-blur border border-[#2d3155] rounded-xl px-5 py-3 flex items-center gap-3">
              <div className="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center font-bold text-white text-sm">87</div>
              <div className="text-left">
                <p className="text-white text-sm font-semibold">Class Engagement</p>
                <p className="text-slate-400 text-xs">Above average</p>
              </div>
            </div>
            <div className="bg-[#1a1d35]/90 backdrop-blur border border-[#2d3155] rounded-xl px-5 py-3 flex items-center gap-3">
              <div className="w-10 h-10 bg-indigo-600 rounded-full flex items-center justify-center text-lg">👥</div>
              <div className="text-left">
                <p className="text-white text-sm font-semibold">24 Students</p>
      ...
      <section className="max-w-6xl mx-auto px-6 -mt-10 mb-20 relative z-10">
      ...
      {/* Features */}
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-[#2d3155]">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4">
            Everything you need to <span className="text-indigo-400">engage students</span>
          </h2>
          <p className="text-slate-400 text-lg">Powerful AI tools designed specifically for educators.</p>
        </div>
        <div className="grid grid-cols-3 gap-4">
          {features.map((f, i) => (
            <div key={i} className="bg-[#1a1d35] border border-[#2d3155] hover:border-indigo-500/50 rounded-xl p-6 transition-colors">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-[#2d3155]">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg">Get started in minutes with our simple 4-step process.</p>
        </div>
        <div className="grid grid-cols-4 gap-6">
          {steps.map((step, i) => (
            <div key={i} className="relative">
              <p className="text-7xl font-bold text-[#2d3155] mb-3">{step.num}</p>
              {i < steps.length - 1 && (
                <div className="absolute top-8 right-0 text-[#2d3155] text-2xl">→</div>
              )}
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 border-t border-[#2d3155]">
        <div className="grid grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-slate-400 mb-8">Join thousands of educators who have transformed their virtual classrooms with AI-powered engagement insights.</p>
          ...
          <div className="relative">
            ...
            {/* Privacy badge */}
            <div className="absolute bottom-4 left-4 bg-[#1a1d35]/95 backdrop-blur border border-[#2d3155] rounded-xl px-4 py-2.5 flex items-center gap-2">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="bg-[#1a1d35] border border-[#2d3155] rounded-2xl p-16 text-center relative overflow-hidden">
          ...
          <p className="text-slate-400 text-lg mb-8 relative z-10">Join ClassLens today and start understanding your students like never before.</p>
          <div className="flex items-center justify-center gap-4 relative z-10">
            ...
            <button onClick={() => navigate('/login')}
              className="border border-[#2d3155] hover:border-indigo-500 text-slate-300 hover:text-white px-8 py-3.5 rounded-xl font-semibold text-lg transition-colors">
              Join as Student
            </button>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="border-t border-[#2d3155] px-6 py-6 text-center text-slate-500 text-sm">
